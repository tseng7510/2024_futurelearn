<div class="privacyBox">本網站使用 cookie 來改善您的瀏覽體驗。我們假設您可以繼續。如果您想了解更多相關信息，請點擊<a target="_blank" href="disclaimer.php"> 使用條款&免責聲明 </a>，謝謝。<div class="closePrivacy">確定</div>
</div>
<div class="floatNav">
  <a href="https://lin.ee/eOKOtHe" target="_blank"></a>
</div>
<?/*放置js區域*/ ?>
